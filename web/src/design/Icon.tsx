...
const ICONS = {
  ...
  'file-spreadsheet': FileSpreadsheet, 'file-text': FileText, 'filter': Filter, 'flame': Flame, 'folder': Folder,
  'gauge': Gauge, 'git-compare': GitCompare, 'globe': Globe, 'grip-vertical': GripVertical,
  'hand-coins': HandCoins, 'hourglass': Hourglass, 'id-card': IdCard, 'inbox': Inbox, 'image-up': ImageUp,
