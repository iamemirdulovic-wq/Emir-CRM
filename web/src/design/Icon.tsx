...
import {
  ...
  ExternalLink, Eye, EyeOff, Facebook, FileBadge, FileBarChart, FileCheck2, FileDown,
  ...
  Plus, Radar, Radio, Receipt, RefreshCw, Repeat, Save, Scale, ScanLine, Search, Send, Settings,
...
const ICONS = {
  ...
  'file-bar-chart': FileBarChart, 'file-check-2': FileCheck2, 'file-down': FileDown,
  ...
  'pencil': Pencil, 'phone': Phone, 'phone-outgoing': PhoneOutgoing, 'pie-chart': PieChart,
